...
(function( root, factory ) {
    if( typeof define === "function" && define.amd ) {
        ...
        Rust.macro_railroad_wasm = factory();
    }
}( this, function() {
    return (function( module_factory ) {
        ...
        if( typeof window === "undefined" && typeof process === "object" ) {
            ...
            var wasm_path = path.join( __dirname, "macro_railroad_wasm.wasm" );
            ...
            return fetch( "macro_railroad_wasm.wasm", {credentials: "same-origin"} )
                ...
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'macro_railroad_wasm':", error );
                    throw error;
                });
        }
    }( function() {
