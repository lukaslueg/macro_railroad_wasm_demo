/* @ts-self-types="./macro_railroad_wasm.d.ts" */

/**
 * @param {string} src
 * @param {boolean} hide_internal
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./macro_railroad_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('macro_railroad_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
